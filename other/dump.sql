...
INSERT INTO `games` VALUES (2,'Helicopters battle',1,'QDxk9K4H987UvrISZAivM2At26KnLgmdEbCQdefJOjmuP');
...
CREATE TABLE `players` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) DEFAULT NULL,
  `player_uniqe_id` varchar(45) DEFAULT NULL,
...
INSERT INTO `players` VALUES (3,'Johny','k48gj38d39w2t',2);
...
CREATE TABLE `saves` (
  ...
  `save_data` varchar(512) DEFAULT NULL,
  `boost_data` varchar(512) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `saves` VALUES (1,1,1,'2e2',NULL),(3,2,3,'','{xxx}');
...
-- Dump completed on 2019-07-05 19:01:21
